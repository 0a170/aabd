...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container-fluid">
   ...
   @if(file_exists('storage\\images\\' . Auth::user()->user_name . '.jpg'))
      <img src="{{ asset('storage\\images\\' . Auth::user()->profile_image) }}" style="height: auto; width: 100%; border-radius: 50%;" data-toggle="modal" data-target="#popupLogin">
	            ...
	            <form id="upl_img" enctype="multipart/form-data" action="upload_image" method="POST">
                  ...
                  {{ csrf_field() }}
                     ...
                     <input type="hidden" value="{{ csrf_token() }}">
						   ...
						   <input type="submit" id="Up_Img" name="Upload_Image" value="Upload">
