$(document).ready(function() {
	...
	$('.aForm').on('submit', function(e) {
	   ...
	   //alert("The form ID: " + fID);
		...
		var failureID = $('#' + fID + ' :nth-child(6)').attr('id');
		//var failureID = $('#' + dID + ' :nth-child(1)').attr('id');
		var successID = $('#' + fID + ' :nth-child(7)').attr('id');
		//var successID = $('#' + dID + ' :nth-child(4)').attr('id');
		var servFailureID = $('#' + fID + ' :nth-child(8)').attr('id');
